...
`\dsaRechtstext{…}` setzt den Wortlaut, der laut Baukasten „stets im Werk enthalten sein" muss, und
trägt das Argument als Copyright-Zeile ein. `\dsaImpressumsblock{Rubrik}{Inhalt}` für die einzelnen
Angaben.
