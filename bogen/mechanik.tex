...
% --- Werte ----------------------------------------------------------------
% \wert{feldname}{Wert} aus helden/<name>.tex. Ein fehlender Wert ist kein
% Fehler, sondern ein leeres Feld.
...
\newcommand{\wertdaP}[1]{\ifcsname wert@#1\endcsname\expandafter\@firstoftwo\else\expandafter\@secondoftwo\fi}
...
% Nachpruefbar mit bau\felder-pruefen.ps1.
