...
% --- Werte einsammeln ------------------------------------------------------
% Dieselbe Datei, die auch mechanik.tex einbindet — nur so läuft
% helden/<name>.tex unverändert durch beide Dokumente.
\input{werte}
% Wert oder Vorgabe. Bleibt hier: die Vorgabe ist ein Gestaltungsmittel der
% Mappe (ein langer Name braucht eine kleinere Schrift), der Bogen kennt
% nichts dergleichen.
