...
% bau/pergament-vorbereiten.py. Die abgeleiteten Dateien liegen in
% bau/ausgabe/ und sind Verlagsmaterial — sie werden nicht weitergegeben,
% wohl aber das fertige PDF (siehe RECHTLICHES auf dem linken Innenblatt).
\newcommand{\pergamentgrund}{%
  \node[anchor=north west,inner sep=0pt] at (0,0)
    {\includegraphics[width=210mm,height=297mm]{bau/ausgabe/pergament-a4.jpg}};}
...
\newcommand{\pergamentkasten}[4]{%
  ...
  \node[anchor=north west,inner sep=0pt] at (#1,#2)
    {\includegraphics[width=#3mm,
       ...
       {bau/ausgabe/pergament-kasten.png}};
