#!/bin/sh
# quelle-vorbereiten.sh -- Weiterleitung. Die Logik steht in quelle-vorbereiten.py.
#
...
#
# Unter Windows: bau/quelle-vorbereiten.ps1
#
# Copyright 2026 Leif Janzik. Apache License 2.0.

exec python3 "$(dirname "$0")/quelle-vorbereiten.py" "$@"
