...
| Solo-Abenteuer | `dsa5solo.sty` | Nummerierte Blöcke mit sprechenden Marken statt Zahlen: das Werkzeug vergibt die Nummern, löst die Verweise auf und verteilt die Blöcke so auf Doppelseiten, dass Quelle und Ziel eines Sprungs nie nebeneinander liegen. Auf Wunsch zusätzlich als klickbare Fassung: derselbe Satz, aber jede Zahl springt auf ihren Block | [Elementreferenz](doku/SOLO.md) |
