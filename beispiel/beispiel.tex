...
\documentclass[raster,rasterzeigen]{dsa5satz}
...
\dsaUmschlagVorne{grafiken/aventurienkarte}{Ein Beispiel}{in zwei Zeilen}
...
\dsaImpressumsblock{Satz, Layout \& Gestaltung}{[Name]}
\dsaImpressumsblock{Layoutvorlagen}{Ulisses Spiele, Scriptorium Aventuris v4}

\dsaRasterluft{2}
\dsaRechtstext{2026 von [Name]}
...
\begin{tabular}{@{}ll@{}}
\hline
1 & jaemmerliche Bruchbude, 50 Prozent\\
3 & einfache Herberge, Normalpreis\\
6 & luxurioese Unterkunft, 400 Prozent\\
\hline
\end{tabular}
