...
Zwischen den Steinen bewegt sich etwas, das größer ist als eine Ratte und schneller.
Es stellt sich zwischen dich und den Ausgang.

\dsaProbe{Mut, erschwert um 1 — oder Körperbeherrschung, um an ihm vorbeizukommen}

\begin{dsaWerteFreiPortrait}[dsaportrait=grafiken/fiole]{18}
{\bfseries Wolfsratte}
...
Beim vierten Mal bleibt er stehen und sieht dich an. Wirf \dsaFormel{1W6}, um zu
sehen, was dir im Gedränge an ihm auffällt:

\dsaTabellenkopf{Was dir an dem Grauen auffällt}
\begin{dsaTabelle}{lL{50mm}}
\dsaTabellenrubrik \dsaRubrikschrift Wurf & \dsaRubrikschrift Was du siehst\\
\textbf{1--2} & Gutes Schuhwerk für einen, der wie ein Bettler geht\\
\textbf{3--4} & Unter dem Umhang zeichnet sich ein Schwertgriff ab\\
\textbf{5--6} & Er ist nicht allein; am Brunnen steht ein zweiter\\
\dsaTabellenrubrik \dsaRubrikschrift Anmerkung
  & \dsaAnmerkungsschrift Der Wurf ändert nichts am Weg, nur an dem, was du weißt\\
\end{dsaTabelle}
...
\begin{dsaKastenFrei}{12}
\dsaKastentitel{Zechen und Zuhören}
Wer in einer Schenke etwas erfahren will, würfelt eine Probe auf Betören oder
Zechen. Gelingt sie, erfährst du eine Kleinigkeit mehr, als im Text steht — und
darfst dir aussuchen, ob du sie glaubst.
\end{dsaKastenFrei}
...
% Dieser Block führt die Option „zusammen“ vor: Bild und Text landen
% gemeinsam in einer Spalte oder gemeinsam in der nächsten, nie getrennt.
% Ohne die Option dürfte der Satz zwischen Bild und Text umbrechen.
\begin{soloBlock}[zusammen]{keller}
...
\begin{soloBlock}[zusammen]{ruecken}
