...
%%% Umschlag vorne und hinten, Kapitelanfang mit Bild, Kreis- und
%%% Freiformmaske, Inhaltsverzeichnis. Ohne Seitenhintergrund, damit ein
%%% Lauf kurz ist.
%%%
%%% Der Umschlag traegt hier den ROTEN Titel (\dsaTitelRot). Den grauen des
%%% Baukastens zeigt beispiel.tex; so wird jede der beiden Fassungen von
%%% einem Lauf gebaut.
%%%
...
% Die Farben des Titels gehoeren in die Praeambel, siehe dsa5latex.cls.
\dsaTitelRot

\begin{document}

\dsaUmschlagVorne{grafiken/aventurienkarte}{%
  \dsaTitelZeile{Ein roter Titel}%
  \dsaTitelZeile[27.9]{in zwei Graden}}
