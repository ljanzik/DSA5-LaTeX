...
% ======================================================================
% Was das Set über sich selbst sagt — neutraler Rand
% ======================================================================
%
% Zwei Karten in der Bauform, die beide veröffentlichten Sets für sich
% selbst benutzen: Kopf und Text, kein Bild, auf beiden Seiten dasselbe.
...
\begin{dsaKarteText}
  ...
  \dsaKartentext{Siebzehn Karten für den Spielleiter: Bewohner,
    Ausrüstung, Zauberwerk und was im Moor lauert. Auf jeder Karte steht,
    was am Tisch in der Hand liegen muss.}
  \dsaKartenstich{Mischen}{Die Verbrauchsgegenstände sind einseitig und
    tragen den gemeinsamen Rücken. Sie lassen sich mischen und verdeckt
    ziehen.}
\end{dsaKarteText}
...
\begin{dsaKarteImpressum}
  ...
  \dsaKartenzeile{Text und Satz}{frei erfunden für dieses Beispiel}
  \dsaKartenzeile{Vorlage}{Scriptorium Aventuris – Spielkarten}
  \dsaKartenzeile{Abbildungen}{Platzhalter aus
    \texttt{kartenplatzhalter.py}}
  \dsaKartenzeile{Klasse}{\texttt{dsa5spielkarten}}
